...
## [3.0.0](https://github.com/pranavkonde/upload-service/compare/console-v2.16.0...console-v3.0.0) (2025-11-20)


### ⚠ BREAKING CHANGES

* fix production deploy by getting release state name right ([#232](https://github.com/pranavkonde/upload-service/issues/232))
* fix production deploy by getting release state name right

### Features

* access revocation ([#421](https://github.com/pranavkonde/upload-service/issues/421)) ([c3377c7](https://github.com/pranavkonde/upload-service/commit/c3377c77fc77b8f0119fa7dabdacaf9549128183))
* add "no redirect" to checkout session capability ([#522](https://github.com/pranavkonde/upload-service/issues/522)) ([51fe726](https://github.com/pranavkonde/upload-service/commit/51fe7263e315170143aab4522561d4c3816d4565))
* Add Account and Space Deletion Request Buttons in Storacha Console ([#438](https://github.com/pranavkonde/upload-service/issues/438)) ([422b7b0](https://github.com/pranavkonde/upload-service/commit/422b7b0e886fbce24e50a15ad569c0194d89c911)), closes [#431](https://github.com/pranavkonde/upload-service/issues/431)
* add blob listing to space detail page ([#351](https://github.com/pranavkonde/upload-service/issues/351)) ([d14484e](https://github.com/pranavkonde/upload-service/commit/d14484ed3cb4db3f4cc45c269faae7ab6bcbad34))
* add Plausible analytics tracking for console.storacha.network([#418](https://github.com/pranavkonde/upload-service/issues/418)) ([749b8af](https://github.com/pranavkonde/upload-service/commit/749b8afa5b7c620667f813d8ca4112dbaf2e27b5))
* Add plausible tracking for console.storacha.network ([84b7066](https://github.com/pranavkonde/upload-service/commit/84b70666ecfaf27a4ebf8474e9a82e45866f40bb))
* Add plausible tracking for console.storacha.network ([b31efbc](https://github.com/pranavkonde/upload-service/commit/b31efbc85aa1bb1c43b289df768098de5589f222))
* Add plausible tracking for users from dmail. ([45fcd9d](https://github.com/pranavkonde/upload-service/commit/45fcd9dfdac091704dfa9b6570465928aa59df77))
* auto-clean user session and continue with SSO flow ([#397](https://github.com/pranavkonde/upload-service/issues/397)) ([f26a3c6](https://github.com/pranavkonde/upload-service/commit/f26a3c646a951748977fb8edddd93e102b9c69ac))
* automatically handle email mismatch in iframe SSO authentication ([#414](https://github.com/pranavkonde/upload-service/issues/414)) ([787739e](https://github.com/pranavkonde/upload-service/commit/787739e55712f3e78725ebfe462323fd79f3ac69))
* configre xenea campaign ([31b2af3](https://github.com/pranavkonde/upload-service/commit/31b2af3f0cfdd58b55acf95543dd3f5b9e9bb4c1))
* **console:** add configurable marketing notice banner for Xenea collaboration ([#369](https://github.com/pranavkonde/upload-service/issues/369)) ([2dc9b8a](https://github.com/pranavkonde/upload-service/commit/2dc9b8a39955d2aa23581ed8638b6d13d51b8c48))
* **console:** plan verification before encryption/decryption operations ([#354](https://github.com/pranavkonde/upload-service/issues/354)) ([fe77ef0](https://github.com/pranavkonde/upload-service/commit/fe77ef0fe993652f3c8ae8c3fa89b4ea4c6b3a6f))
* **console:** private spaces  ([#310](https://github.com/pranavkonde/upload-service/issues/310)) ([bd4a0da](https://github.com/pranavkonde/upload-service/commit/bd4a0da0b85e696a1aa293bfe6ca49c60c546b0b))
* cyberlife privacy free trial ([#528](https://github.com/pranavkonde/upload-service/issues/528)) ([6139695](https://github.com/pranavkonde/upload-service/commit/61396950cc53bb8df04dc997680ef9a9da5512f5))
* enable free privacy for zkagi ([#519](https://github.com/pranavkonde/upload-service/issues/519)) ([c9d8d93](https://github.com/pranavkonde/upload-service/commit/c9d8d9354b8192591c860843cbb9ba93c27aa229))
* link to space from usage table ([#494](https://github.com/pranavkonde/upload-service/issues/494)) ([f14dd8c](https://github.com/pranavkonde/upload-service/commit/f14dd8cb15fbd3089e9eb494a7e5880908405fb9))
* new checkout session invocation and custom pricing table ([#453](https://github.com/pranavkonde/upload-service/issues/453)) ([9c822ef](https://github.com/pranavkonde/upload-service/commit/9c822efe5551dfb04622c78fd9d5e4b0fa2a558a))
* remove migrations UI from console ([#450](https://github.com/pranavkonde/upload-service/issues/450)) ([9ea83f0](https://github.com/pranavkonde/upload-service/commit/9ea83f025cfbf14df33409f3a33ef76903473030))
* **repo:** merge main from https://github.com/storacha/console ([152954e](https://github.com/pranavkonde/upload-service/commit/152954ee26c66bdd9bb686581b100d66ca0bcfca))
* SSO authentication flow + Iframe support for Console ([#317](https://github.com/pranavkonde/upload-service/issues/317)) ([408ac17](https://github.com/pranavkonde/upload-service/commit/408ac17cbfb4105321229bdca39d8ad8e9a0a053))
* sso integration guide ([#343](https://github.com/pranavkonde/upload-service/issues/343)) ([2be4dbb](https://github.com/pranavkonde/upload-service/commit/2be4dbbc8dbc3d6369cf1126a6b6159368dac732))
* trigger console release ([c2ce9b4](https://github.com/pranavkonde/upload-service/commit/c2ce9b4ad355841253dd760a2040e4f75ea199d3))
* trigger console release ([#513](https://github.com/pranavkonde/upload-service/issues/513)) ([381ad5d](https://github.com/pranavkonde/upload-service/commit/381ad5d1b1c61908d755f9349e04e352f11a446e))
* upgrade to new humanode CVM ([#451](https://github.com/pranavkonde/upload-service/issues/451)) ([6f89301](https://github.com/pranavkonde/upload-service/commit/6f8930178626b0c1f4929889dada52b9a2dc8631))
* upgrade to next 15 ([#512](https://github.com/pranavkonde/upload-service/issues/512)) ([1f6adb4](https://github.com/pranavkonde/upload-service/commit/1f6adb494af30c768d0817e8f1cc5bad849ea122))
* **upload-api:** enforce space limit on blob/add ([#386](https://github.com/pranavkonde/upload-service/issues/386)) ([589ff6a](https://github.com/pranavkonde/upload-service/commit/589ff6a5543d12893b69cd35150701993dccc55d))
* **upload-api:** implement account-usage/get ([9347614](https://github.com/pranavkonde/upload-service/commit/93476147b2aadbeede65345e358abbd13d508bff))


### Fixes

* "revert feat: auto-clean user session and continue with SSO flow ([#397](https://github.com/pranavkonde/upload-service/issues/397))" ([#403](https://github.com/pranavkonde/upload-service/issues/403)) ([94f94cd](https://github.com/pranavkonde/upload-service/commit/94f94cd22a22f9bfac664d942177e92401509db3))
* a little package.json cleanup ([13859fc](https://github.com/pranavkonde/upload-service/commit/13859fc29757cf85653db741be6f980f11fe5eb0))
* **access:** include session proofs issued by service aliases in invocations ([#328](https://github.com/pranavkonde/upload-service/issues/328)) ([9de1d95](https://github.com/pranavkonde/upload-service/commit/9de1d95dd1e618f648d6823574767da04b8d671b))
* add more deps to the catalog and pin eslint typescript plugin ([e00af97](https://github.com/pranavkonde/upload-service/commit/e00af972f0a2710f673a6ea367ed6f81912e4145))
* add plan-get delegation to the decryption request ([#372](https://github.com/pranavkonde/upload-service/issues/372)) ([4456801](https://github.com/pranavkonde/upload-service/commit/445680135ca3827c64a7ed5a43cc4e5c59b0f030))
* auto refresh pricing table in iframe context ([#390](https://github.com/pranavkonde/upload-service/issues/390)) ([b96485b](https://github.com/pranavkonde/upload-service/commit/b96485b647aad87f9f87f847405e43a1f6808a85))
* better error logging ([#448](https://github.com/pranavkonde/upload-service/issues/448)) ([f549d53](https://github.com/pranavkonde/upload-service/commit/f549d5390ccf291ebce463a97a9ab44d0b3f1e2f))
* capture some errors we were logging to console ([#188](https://github.com/pranavkonde/upload-service/issues/188)) ([673043a](https://github.com/pranavkonde/upload-service/commit/673043ab6e5bc8166229c6021f45b81191b917fa))
* catalog more dependencies ([cc52f81](https://github.com/pranavkonde/upload-service/commit/cc52f81f40e6d28ebe1e1c910e67b0de9d324a42))
* console build and encryption lib ([#308](https://github.com/pranavkonde/upload-service/issues/308)) ([9eccbc8](https://github.com/pranavkonde/upload-service/commit/9eccbc822b6d0ab39d52b576c11faeeeaa05a60a))
* **Console UI:** Keep Sidebar & Navbar Fixed, Enable Content-Only Scrolling ([#441](https://github.com/pranavkonde/upload-service/issues/441)) ([01672df](https://github.com/pranavkonde/upload-service/commit/01672dfe91dfbc04e7f6cb99d52e9450bc00ecb3)), closes [#434](https://github.com/pranavkonde/upload-service/issues/434)
* **console:** add gmail spam warning, see [#415](https://github.com/pranavkonde/upload-service/issues/415) ([#416](https://github.com/pranavkonde/upload-service/issues/416)) ([900f6c2](https://github.com/pranavkonde/upload-service/commit/900f6c26668d69beb6f5b90dd1515bf89103414c))
* **console:** add SSO environment vars to template ([#329](https://github.com/pranavkonde/upload-service/issues/329)) ([20ceba2](https://github.com/pranavkonde/upload-service/commit/20ceba239f85afbdd66d9a674b533ecb4ce4237e))
* **console:** origin verification for msg channels ([#325](https://github.com/pranavkonde/upload-service/issues/325)) ([d7bb1b4](https://github.com/pranavkonde/upload-service/commit/d7bb1b44f35c5b036327ebbf173742f4950cd404))
* **console:** pnpm run dev + nx configs(sentry,tailwind) ([ad5db7e](https://github.com/pranavkonde/upload-service/commit/ad5db7e3b2a9630185600d31e4de159abe27578a))
* **console:** resolve sidebar height issue for full page coverage ([#381](https://github.com/pranavkonde/upload-service/issues/381)) ([6f7bd68](https://github.com/pranavkonde/upload-service/commit/6f7bd68eedbed89eda620fc1b877a0df61e42a23)), closes [#368](https://github.com/pranavkonde/upload-service/issues/368)
* **console:** several fixes for mobile/smaller dimensions windows ([#345](https://github.com/pranavkonde/upload-service/issues/345)) ([b0b12b3](https://github.com/pranavkonde/upload-service/commit/b0b12b3f9d0dab66135679a0b21e084f1578cce9))
* **console:** trigger console app release ([5deb02b](https://github.com/pranavkonde/upload-service/commit/5deb02b59aa46d75575f992ddc70a14f2c1bc555))
* **console:** trigger console staging deploy ([3db6cc4](https://github.com/pranavkonde/upload-service/commit/3db6cc45c84271dd4b579d6b8a078f5d21ed0832))
* decrypt delegation should not include plan/get proof  ([#375](https://github.com/pranavkonde/upload-service/issues/375)) ([bb040e7](https://github.com/pranavkonde/upload-service/commit/bb040e77bf8d4fc6e3857ab73920076da5212294))
* detect "plan not found" errors correctly ([#337](https://github.com/pranavkonde/upload-service/issues/337)) ([81eeff4](https://github.com/pranavkonde/upload-service/commit/81eeff4adef6081a883770aa09015f746ee1aea7))
* fix linting ([0c5f06b](https://github.com/pranavkonde/upload-service/commit/0c5f06b7c95c86b0e1e40d38916800682cd30dc6))
* fix production deploy by getting release state name right ([546fb2c](https://github.com/pranavkonde/upload-service/commit/546fb2c22af70542352a23cb2917655e467f25fb))
* fix production deploy by getting release state name right ([#232](https://github.com/pranavkonde/upload-service/issues/232)) ([408da70](https://github.com/pranavkonde/upload-service/commit/408da705090bc8e2e5ca0bf11db3b6d95f3358a0))
* gateway host in console ([#321](https://github.com/pranavkonde/upload-service/issues/321)) ([68fa445](https://github.com/pranavkonde/upload-service/commit/68fa445d0b6fdfd2b9870d6ac28e0ae1e4c1bdd1))
* Humanode config tweaks ([b3debc4](https://github.com/pranavkonde/upload-service/commit/b3debc4f1ecdb003b403e89e674f0c56cdb04dd8))
* include plan/get proofs in decrypt op ([#365](https://github.com/pranavkonde/upload-service/issues/365)) ([4f88159](https://github.com/pranavkonde/upload-service/commit/4f881590551e7026102adb8bc60cf8751c0fc072))
* init page loading right after button click + stop on errors ([220df2d](https://github.com/pranavkonde/upload-service/commit/220df2d38333f3ae17827483edf9dae92918c244))
* integration docs and iframe download config ([#383](https://github.com/pranavkonde/upload-service/issues/383)) ([5ca0615](https://github.com/pranavkonde/upload-service/commit/5ca06151461cf286bf9b8d29b9b70ab22c9922e3))
* is this enough? ([ac552ac](https://github.com/pranavkonde/upload-service/commit/ac552ac18c8292c7a9b38a9f68fbac2e4bf6c75a))
* lock down next and react versions ([4d316af](https://github.com/pranavkonde/upload-service/commit/4d316afa44902ca76523a324520d4090a434bd71))
* prevent iframe auto-refresh and auth loops + fix ci build issue ([#385](https://github.com/pranavkonde/upload-service/issues/385)) ([53b77be](https://github.com/pranavkonde/upload-service/commit/53b77bece0d8bd96ffd8b26e5cb38b3e93ed5ef4))
* remove console github configs ([b5a2307](https://github.com/pranavkonde/upload-service/commit/b5a23077aaec5ba63108b5b16e7d333adececdc5))
* remove console github configs ([#227](https://github.com/pranavkonde/upload-service/issues/227)) ([71db228](https://github.com/pranavkonde/upload-service/commit/71db2284f902194581d6ccb95b88f92822e3cfee))
* remove sentry test page ([b442306](https://github.com/pranavkonde/upload-service/commit/b4423060dbfd8f82f3792244610953bb51562833))
* remove sentry test page ([#231](https://github.com/pranavkonde/upload-service/issues/231)) ([f4071dc](https://github.com/pranavkonde/upload-service/commit/f4071dca72132e41716b658edb1e783b7fc33798))
* show an error screen when we encounter an error loading the user's plan ([#314](https://github.com/pranavkonde/upload-service/issues/314)) ([a74e0c2](https://github.com/pranavkonde/upload-service/commit/a74e0c2418442132d5022ab7f4d48ebba5bc453f))
* trigger a console release ([b9862a1](https://github.com/pranavkonde/upload-service/commit/b9862a1bd2092a1f37c817f21475ddb31c975cf3))
* trigger a console release ([#228](https://github.com/pranavkonde/upload-service/issues/228)) ([d9677d8](https://github.com/pranavkonde/upload-service/commit/d9677d8b256750ce2acfda3927a94e3cc674405c))
* trigger console app release ([09978db](https://github.com/pranavkonde/upload-service/commit/09978db795f73cdceaed48f40c737ff420452556))
* trigger console deployment ([38d3c8b](https://github.com/pranavkonde/upload-service/commit/38d3c8bef3c4be68bbe6ed51ce4334fcbdd96ed7))
* tweak to test console deploy ([#509](https://github.com/pranavkonde/upload-service/issues/509)) ([5c733b5](https://github.com/pranavkonde/upload-service/commit/5c733b5488b4c3dbcd11aac76853840a8641686e))
* two improvements to new plan gate ([#543](https://github.com/pranavkonde/upload-service/issues/543)) ([5297f9c](https://github.com/pranavkonde/upload-service/commit/5297f9ca0542b1c397676bc5593b67f26f15b050))
* Typo ([#435](https://github.com/pranavkonde/upload-service/issues/435)) ([b384c05](https://github.com/pranavkonde/upload-service/commit/b384c05c37f8c02a05ed83fd707b04356ff51398))
* update packages to use catalog dependencies ([9191594](https://github.com/pranavkonde/upload-service/commit/9191594fb49a1e7aee6fb609fa772dfff91ae1e2))
* update the upload-service DIDs ([#427](https://github.com/pranavkonde/upload-service/issues/427)) ([d670007](https://github.com/pranavkonde/upload-service/commit/d6700079893f7d715a1cf7ad1855a1da16c91f86))
* upgrade to enable private spaces ([#348](https://github.com/pranavkonde/upload-service/issues/348)) ([b2b90b1](https://github.com/pranavkonde/upload-service/commit/b2b90b15d6bcd9badfd6c09e52add420b316621e))
* use new `account/usage/get` capability to get account usage ([#460](https://github.com/pranavkonde/upload-service/issues/460)) ([76ff5ee](https://github.com/pranavkonde/upload-service/commit/76ff5ee25cc4d38d6415e8e73f837a29e260e306))
* Use next-plausible instead of plausible analytics-tracker. ([8f015c5](https://github.com/pranavkonde/upload-service/commit/8f015c526196106a9a8f8ab4d616ecb4f78690fa))


### Other Changes

* import console ([#139](https://github.com/pranavkonde/upload-service/issues/139)) ([59ebc4e](https://github.com/pranavkonde/upload-service/commit/59ebc4ecdb83cd35a35044d19821e8ea95c33121))
* **main:** release console 1.18.0 ([b609113](https://github.com/pranavkonde/upload-service/commit/b609113c76e7b3465fd3162e2fb7749721e57c5f))
* **main:** release console 1.18.0 ([#229](https://github.com/pranavkonde/upload-service/issues/229)) ([0372989](https://github.com/pranavkonde/upload-service/commit/0372989192c4e68900dc11155741f887b27c09ad))
* **main:** release console 2.0.0 ([cab9ed2](https://github.com/pranavkonde/upload-service/commit/cab9ed2e390d82e15a9d7327693d815384d8994f))
* **main:** release console 2.0.0 ([#233](https://github.com/pranavkonde/upload-service/issues/233)) ([0219d4d](https://github.com/pranavkonde/upload-service/commit/0219d4d55bbc350a14d3e2ecb3c71d90e1ff036f))
* **main:** release console 2.0.1 ([44e68f0](https://github.com/pranavkonde/upload-service/commit/44e68f068a469d93509ccc1289a8ec132c3e18c0))
* **main:** release console 2.0.1 ([#235](https://github.com/pranavkonde/upload-service/issues/235)) ([1743293](https://github.com/pranavkonde/upload-service/commit/1743293986780328f109e5a26f71cb7c1b897c9f))
* **main:** release console 2.0.2 ([#252](https://github.com/pranavkonde/upload-service/issues/252)) ([9e9039a](https://github.com/pranavkonde/upload-service/commit/9e9039aec7b4f17a6d2e33accf7c6aaf56ccf601))
* **main:** release console 2.0.3 ([#322](https://github.com/pranavkonde/upload-service/issues/322)) ([fc0b154](https://github.com/pranavkonde/upload-service/commit/fc0b15475159b0ce89aab126743bc1039321c485))
* **main:** release console 2.1.0 ([#323](https://github.com/pranavkonde/upload-service/issues/323)) ([b1e0eb0](https://github.com/pranavkonde/upload-service/commit/b1e0eb09779ff7f284ec7e542f4e14d609e2311e))
* **main:** release console 2.1.1 ([#326](https://github.com/pranavkonde/upload-service/issues/326)) ([239045e](https://github.com/pranavkonde/upload-service/commit/239045e203c042a08268d9cc6dc0e059525c675b))
* **main:** release console 2.1.2 ([#330](https://github.com/pranavkonde/upload-service/issues/330)) ([710094b](https://github.com/pranavkonde/upload-service/commit/710094b178822761ed34b7437e83cbcbe3113a59))
* **main:** release console 2.1.3 ([#338](https://github.com/pranavkonde/upload-service/issues/338)) ([ce7101f](https://github.com/pranavkonde/upload-service/commit/ce7101f3cdeaa203cb89bc41b7d637c2ed989f24))
* **main:** release console 2.10.0 ([#465](https://github.com/pranavkonde/upload-service/issues/465)) ([d8699cf](https://github.com/pranavkonde/upload-service/commit/d8699cf5f5034cdcf6e162d5741efacb20efb756))
* **main:** release console 2.11.0 ([#495](https://github.com/pranavkonde/upload-service/issues/495)) ([0ff1b7c](https://github.com/pranavkonde/upload-service/commit/0ff1b7c7504bc6e95d07a1efc54644e4bb3482ab))
* **main:** release console 2.11.1 ([#505](https://github.com/pranavkonde/upload-service/issues/505)) ([eb003ed](https://github.com/pranavkonde/upload-service/commit/eb003edb7f282c6cdaab7917a84a5360a9103246))
* **main:** release console 2.11.2 ([#510](https://github.com/pranavkonde/upload-service/issues/510)) ([a4a8b29](https://github.com/pranavkonde/upload-service/commit/a4a8b290b0d8636fdb384978ece776196c6516c5))
* **main:** release console 2.12.0 ([#514](https://github.com/pranavkonde/upload-service/issues/514)) ([311ce37](https://github.com/pranavkonde/upload-service/commit/311ce37d7564cb8b7134e95390b6d6a49934dc76))
* **main:** release console 2.13.0 ([#515](https://github.com/pranavkonde/upload-service/issues/515)) ([dc21135](https://github.com/pranavkonde/upload-service/commit/dc21135457f8fc8e0d0c8c4d8712c56d1b3ec534))
* **main:** release console 2.14.0 ([#518](https://github.com/pranavkonde/upload-service/issues/518)) ([76a95c8](https://github.com/pranavkonde/upload-service/commit/76a95c89cab7e846f19744d69fd9477cdd06c8e1))
* **main:** release console 2.15.0 ([#520](https://github.com/pranavkonde/upload-service/issues/520)) ([9830012](https://github.com/pranavkonde/upload-service/commit/9830012a396b82312b80ebb39d80c3444c190634))
* **main:** release console 2.16.0 ([#521](https://github.com/pranavkonde/upload-service/issues/521)) ([2cc2d5d](https://github.com/pranavkonde/upload-service/commit/2cc2d5de890ec497f79a2198199536242efb58f8))
* **main:** release console 2.2.0 ([#344](https://github.com/pranavkonde/upload-service/issues/344)) ([427cd6a](https://github.com/pranavkonde/upload-service/commit/427cd6ad74add5b8aed27b2cd1b4079286c89b6b))
* **main:** release console 2.2.1 ([#347](https://github.com/pranavkonde/upload-service/issues/347)) ([8757182](https://github.com/pranavkonde/upload-service/commit/8757182c6c664f4375f84d9daccc5f648ca53236))
* **main:** release console 2.3.0 ([#355](https://github.com/pranavkonde/upload-service/issues/355)) ([ddfa7cb](https://github.com/pranavkonde/upload-service/commit/ddfa7cb5ff8acf8baffd65a55238733c07c6d073))
* **main:** release console 2.3.1 ([#364](https://github.com/pranavkonde/upload-service/issues/364)) ([9d73766](https://github.com/pranavkonde/upload-service/commit/9d737664b5012b4a424c2e327fe8bf6c5608a998))
* **main:** release console 2.3.2 ([#366](https://github.com/pranavkonde/upload-service/issues/366)) ([9d86599](https://github.com/pranavkonde/upload-service/commit/9d8659940b559c883f20873683c9fc881ff1bf64))
* **main:** release console 2.3.3 ([#374](https://github.com/pranavkonde/upload-service/issues/374)) ([5bedfd7](https://github.com/pranavkonde/upload-service/commit/5bedfd7a2381c5894b021626b8b82bd2159a741d))
* **main:** release console 2.3.4 ([#380](https://github.com/pranavkonde/upload-service/issues/380)) ([6f97da8](https://github.com/pranavkonde/upload-service/commit/6f97da866ad7d949df73bc45d34c5d09163391eb))
* **main:** release console 2.3.5 ([#384](https://github.com/pranavkonde/upload-service/issues/384)) ([15b6d5d](https://github.com/pranavkonde/upload-service/commit/15b6d5dd79d87bdf00c9f3d17d2e54cafb4a3f19))
* **main:** release console 2.3.6 ([#388](https://github.com/pranavkonde/upload-service/issues/388)) ([f3acf71](https://github.com/pranavkonde/upload-service/commit/f3acf71147b9cbfeabc8205a7ed5a2feb6baa19c))
* **main:** release console 2.3.7 ([#391](https://github.com/pranavkonde/upload-service/issues/391)) ([7ee7783](https://github.com/pranavkonde/upload-service/commit/7ee7783db2fd97a9a32feaba546a63d038a49b09))
* **main:** release console 2.4.0 ([#404](https://github.com/pranavkonde/upload-service/issues/404)) ([c829618](https://github.com/pranavkonde/upload-service/commit/c829618026c5e6a5c0b2f827e2b4f5e95741a0f2))
* **main:** release console 2.4.1 ([#417](https://github.com/pranavkonde/upload-service/issues/417)) ([f1851bd](https://github.com/pranavkonde/upload-service/commit/f1851bdc18a2b7dd9ab97f643c43f33740636dbc))
* **main:** release console 2.5.0 ([a826479](https://github.com/pranavkonde/upload-service/commit/a8264791da49e5dedd1c43ac4ccfc330c0566b98))
* **main:** release console 2.5.1 ([#429](https://github.com/pranavkonde/upload-service/issues/429)) ([fa4d55a](https://github.com/pranavkonde/upload-service/commit/fa4d55a718013dd06acc77ce22abf4c3143ae0b5))
* **main:** release console 2.6.0 ([f041dca](https://github.com/pranavkonde/upload-service/commit/f041dca52b800413328dd35530d65d7cceb825c3))
* **main:** release console 2.6.0 ([#432](https://github.com/pranavkonde/upload-service/issues/432)) ([2bef999](https://github.com/pranavkonde/upload-service/commit/2bef99912ab32358c9de8eaa012648228afe2ed0))
* **main:** release console 2.7.0 ([#433](https://github.com/pranavkonde/upload-service/issues/433)) ([cd9e3b2](https://github.com/pranavkonde/upload-service/commit/cd9e3b2171af60fc840588506e29d41c08820f5e))
* **main:** release console 2.8.0 ([#443](https://github.com/pranavkonde/upload-service/issues/443)) ([7183917](https://github.com/pranavkonde/upload-service/commit/71839171fcc2cd1c1988c6bf55feded6c0de4358))
* **main:** release console 2.9.0 ([#449](https://github.com/pranavkonde/upload-service/issues/449)) ([ad5c0b5](https://github.com/pranavkonde/upload-service/commit/ad5c0b5e9c2eb3f45dd1d170e9e816a1f7e9c5ab))
* nx sync ([5933677](https://github.com/pranavkonde/upload-service/commit/5933677dff7326ecb53316e0081fc8ebc1a7a077))
* **release:** publish ([c4e84af](https://github.com/pranavkonde/upload-service/commit/c4e84af5e71a1e01c7627782963701b66122bd42))
* **release:** publish ([8ed7689](https://github.com/pranavkonde/upload-service/commit/8ed768945a14282ac9c9e5af3105f6859815a140))
* **release:** publish ([49088de](https://github.com/pranavkonde/upload-service/commit/49088de16bb19a7c375d79e4f26ff6aa5903e420))
* **release:** publish ([27a2dc5](https://github.com/pranavkonde/upload-service/commit/27a2dc568ffec5d7cf79dab7e0b0c3d081169398))
* **release:** publish ([cd783a4](https://github.com/pranavkonde/upload-service/commit/cd783a43505cadcb57a242c9df45e9b30d9fa032))
* **release:** publish ([8a1ae63](https://github.com/pranavkonde/upload-service/commit/8a1ae630dcd0c6e01f1a1190f7bf4b0cb5d0cbba))
* remove errant e from deploy script ([ef259f7](https://github.com/pranavkonde/upload-service/commit/ef259f708c7094f622b3431ee9a6d9f495bf2d45))
* remove errant e from deploy script ([#234](https://github.com/pranavkonde/upload-service/issues/234)) ([1130e4e](https://github.com/pranavkonde/upload-service/commit/1130e4e8b27e1e33afe48e7ad197e4ac8416ebd1))
* trigger console staging release ([69c1264](https://github.com/pranavkonde/upload-service/commit/69c126438e380cd219a803c2cfc75c6ca91e7a8d))
